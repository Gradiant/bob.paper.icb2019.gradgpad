...
from bob.paper.icb2019.gradgpad import MsuIqmFeaturesExtractor
...
# Feature extraction:
feature_extractor = MsuIqmFeaturesExtractor(face_crop=True)

# Pipeline:
pipeline = get_pipeline_average_features_scaled_rbfsvc('msu_iqm_rbf_svc')
...
extracted_features_path = 'resources_bob_paper_icb2019_gradgpad/msuiqm_face_cropped/ACE/aggregate-database/features'
