...
project = u'bob.paper.icb2019.gradgpad'
import time
...
short_description = u'Package for reproducing the paper 14 in the Handbook of Biometric Anti-Spoofing: Presentation Attack Detection, 2nd Edition.'
owner = [u'Gradiant']
